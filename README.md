...
Рисунок 16 - Результат выполнения метода Delete
...
Рисунок 17 - проверка удаления через метод Read 
